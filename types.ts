...
export type Screen = 'home' | 'likes' | 'messages' | 'resources' | 'profile' | 'chat' | 'profileDetail' | 'videoCall' | 'verification' | 'editProfile' | 'managePhotos' | 'auth' | 'payment';
...
export enum ChildrenStatus {
    None = "No children at all",
    HasChildren = "Has child / children",
}
